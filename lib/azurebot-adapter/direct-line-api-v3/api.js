...
async function sendActivity(uuid, conversationId, conversationToken, message, remainingAttempts = 3) {
    ...
    try {
        ...
        if (remainingAttempts === 1) throw new errors.TooManyAttemptsError(error, 'Direct Line API: send activity');
...
async function listActivities(conversationId, conversationToken, remainingAttempts = 3) {
    ...
    try {
        ...
        if (remainingAttempts === 1) throw new errors.TooManyAttemptsError(error, 'Direct Line API: list activities')
